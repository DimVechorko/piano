...
$(document).ready(function() {
	...
	if(mobile != null) {
		...
		$('#volni').css('display','block');
		$('#volna_one').css('display','none');
		$('#volna_two').css('display','none');
		$('#volna_three').css('display','none');
		$('#video').css('display','none');
		// $('#video_header').css('background','black url(img/bg1.jpg)no-repeat center bottom');
		$('#volna_three').css('display','none');
	} else {
		$('#volni').css('display','none');
		$('#volna_one').css('display','block');
		$('#volna_two').css('display','block');
		$('#volna_three').css('display','block');
		$('#video').css('display','block');
		// $('#video_header').css('background','rgba(0,0,0,0)');
