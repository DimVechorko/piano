...
if (isset($_POST["go"])) {
    $id = array_pop($_POST);
    DB::update(DB::updateSql($table,$_POST),$_POST,$id);
    header("Location: ".$_SERVER['REQUEST_URI']);
}
$record = DB::select($table);
require_once 'view/tpl_top.php';
?>
<div class="app app-header-fixed  ">
	<? include "view/header.php";
	$active_o = "class=\"active\""; include "view/nav.php"; ?>
	<!-- content -->
						...
						<form method="post" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="btn btn-success button">Сохранить</div>
		                        </div>
							</div>
						</form>
					</div>
